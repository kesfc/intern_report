...
\begin{figure}[H]
    \centering
    \resizebox{0.49\textwidth}{0.35\textwidth}{\includegraphics{picture/32.png}}
    \hspace{0cm} % 调整两张图片之间的水平间距
    \resizebox{0.49\textwidth}{0.35\textwidth}{\includegraphics{picture/33.png}}
    \caption{mesh输出结果}
\end{figure}
\makespace
...
\begin{figure}[H]
    \centering
    \resizebox{0.45\textwidth}{0.45\textwidth}{\includegraphics{picture/34.png}}
    \hspace{0cm} % 调整两张图片之间的水平间距
    \resizebox{0.45\textwidth}{0.45\textwidth}{\includegraphics{picture/35.png}}
    \caption{NeuS输出结果1}
\end{figure}
